...
> Last updated: 2026-09-12 (K25 phase B2b: the `zircon_kpacker` host tool +
> the offline wholesale-rewrite mutation model + the `_kpack_names.json`
> sidecar; B2a's `.kpack` v1 format/reader/writer landed the same day —
> see the K25 row).
