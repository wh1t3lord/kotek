...
> Last updated: 2026-09-05 (exe-side input feeding landed — the window installs the
> GLFW callbacks on the live exe-side GLFW copy and feeds ktkInput directly, the
> static-GLFW-per-module disease class fixed for input after imgui; see the K26 row).
