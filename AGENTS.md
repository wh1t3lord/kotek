...
> Last updated: 2026-09-12 (K25 phase B4: the fault-tolerant defaults chain
> landed zircon-side (zircon Z23) — the filesystem overhaul is COMPLETE, all
> six phases B0/B1/B2a/B2b/B3/B4 done; see the K25 row).
