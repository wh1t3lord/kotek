...
> Last updated: 2026-07-25 (K11 phase 1: NRI v180 backend live — `kotek.render.nri`
> over D3D12, `--render_nri_dx12`, boot-verified exit 0; math constexpr CI fix; see
> the K11/K5 registry rows).
