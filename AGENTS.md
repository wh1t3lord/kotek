...
> Last updated: 2026-09-12 (K25 "API simplicity": the free-function
> filesystem helpers landed — `kotek_filesystem_helpers.h`; the overhaul is
> COMPLETE incl. all six phases B0/B1/B2a/B2b/B3/B4; see the K25 row).
