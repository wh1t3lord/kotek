...
> Last updated: 2026-09-12 (K25 phase B3: the filesystem streaming API is REAL —
> bounded pool, native-CRT/VFM-mapped/pack-block backends, forward-only HDD
> discipline; B0/B1/B2a/B2b landed earlier — see the K25 row).
