...
> Last updated: 2026-09-12 (K25 follow-up: the consumer usage guide
> `doc/git/en/filesystem.md` (zircon repo) + the `test_hdd_*` HDD-evidence
> benchmark suites in kotek_core_test_filesystem.cpp; see the K25 row).
