...
ktkMainManager::ktkMainManager(int argc, char** argv) :
	...
	m_p_manager_render_resource{}, m_p_manager_render_geometry{},
	m_p_manager_render_graph{},
...
ktkIRenderGeometryManager* ktkMainManager::GetRenderGeometryManager(
	void) const noexcept
{
	return this->m_p_manager_render_geometry;
}

void ktkMainManager::SetRenderGeometryManager(
	ktkIRenderGeometryManager* pointer) noexcept
{
	this->m_p_manager_render_geometry = pointer;
}
...
ktkIFrameworkConfig* ktkMainManager::Get_EngineConfig(void) const noexcept
{
