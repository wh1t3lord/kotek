...
bool InitializeModule_Core_Defines_Static_Render(ktkMainManager* p_manager)
{
	...
	KOTEK_INVOKE_MODULE(INIT, CORE, InitializeModule_Core_Defines_Static_Render_DirectX, p_manager);
#endif

#ifdef KOTEK_USE_OPENGL
	KOTEK_INVOKE_MODULE(INIT, CORE, InitializeModule_Core_Defines_Static_Render_OpenGL, p_manager);
#endif

#ifdef KOTEK_USE_VULKAN
	KOTEK_INVOKE_MODULE(INIT, CORE, InitializeModule_Core_Defines_Static_Render_Vulkan, p_manager);
#endif

#ifdef KOTEK_USE_BGFX
	KOTEK_INVOKE_MODULE(INIT, CORE, InitializeModule_Core_Defines_Static_Render_BGFX, p_manager);
#endif
...
{
#ifdef KOTEK_USE_DIRECTX
	KOTEK_INVOKE_MODULE(SHUTDOWN, CORE, ShutdownModule_Core_Defines_Static_Render_DirectX, p_manager);
#endif

#ifdef KOTEK_USE_OPENGL
	KOTEK_INVOKE_MODULE(SHUTDOWN, CORE, ShutdownModule_Core_Defines_Static_Render_OpenGL, p_manager);
#endif

#ifdef KOTEK_USE_VULKAN
	KOTEK_INVOKE_MODULE(SHUTDOWN, CORE, ShutdownModule_Core_Defines_Static_Render_Vulkan, p_manager);
#endif

#ifdef KOTEK_USE_BGFX
	KOTEK_INVOKE_MODULE(SHUTDOWN, CORE, ShutdownModule_Core_Defines_Static_Render_BGFX, p_manager);
#endif
