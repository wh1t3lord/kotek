...
TEST(Math, equal_function_for_floats_are_not_equal)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1, test2) == false
	);
}
...
TEST(Math, equal_function_for_floats_must_be_equal)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1, test2) == true
	);
}
...
TEST(Math, equal_function_for_floats_when_we_sum)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1 + test2, 9.0f) == true
	);
}
...
TEST(Math, equal_function_for_floats_when_we_sum_dirty)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1 + test2, 6.03f) ==
		false
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.x(), (8.4f / 2.6f))
	);
}
...
TEST(Math, vector2f_testing_constructor_based_on_number)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(vec.x(), 5.0f) &&
...
{
	kn_kotek::kn_ktk::kn_math::vector2f vec_original(
		550.5f, 153.2f
	);
	kn_kotek::kn_ktk::kn_math::vector2f vec_copy(vec_original);

	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(
			vec_original.x(), vec_copy.x()
		) &&
		kn_kotek::kn_ktk::is_equal(
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(some.x(), some2.x()) &&
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(some2.x(), some.x) &&
...
TEST(Math, vector2f_testing_setter_single_depth)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test.x(), 105.0f) &&
...
TEST(Math, vector2f_testing_plus_equal_operator_based_on_vector)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.x(), 5.0f) &&
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.x(), 2.0f) &&
...
)
{
	...
	EXPECT_TRUE(kn_kotek::kn_ktk::is_equal(test1.x(), 11.0f));
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.y(), (6.4f * 252.1f))
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.x(), (8.4f / 2.0f))
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.y(), (2.6f / 2.0f))
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.y(), (3.5f / 0.5f))
	);
}
...
TEST(Math, vector2f_testing_binary_plus_operator_both_vectors)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(50.5f + 5.5f, new_vector.x())
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(2.5f + 0.5f, new_vector.y())
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(50.5f - 0.5f, new_vector.x())
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(25.0f - 5.0f, new_vector.y())
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(5.5f * 2.2f, new_vector.x())
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(25.5f * 5.5f, new_vector.y())
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(2.5f * 2.2f, new_vector.y())
	);
}
...
TEST(Math, vector2f_testing_binary_divide_operator_both_vectors)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(6.6f / 0.2f, new_vector.x())
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(3.6f / 0.4f, new_vector.y())
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(3.6f / 0.2f, new_vector.y())
	);
}
...
{
	kn_kotek::kn_ktk::kn_math::base_vec3_t data = {
		5.0f, 6.0f, 7.0f
	};
...
{
	kn_kotek::kn_ktk::kn_math::vector3f vec_original(
...
{
	kn_kotek::kn_ktk::kn_math::vector3f some(
		50.0f, 25.4f, 252.0f
	);
...
{
	kn_kotek::kn_ktk::kn_math::base_vec3_t some(
		51.0f, 15.3f, 25.0f
	);
	kn_kotek::kn_ktk::kn_math::vector3f some2 = some;
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.x(), 2.0f * 5.5f)
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.y(), 6.4f * 5.5f)
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.z(), 4.4f * 5.5f)
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.z(), (25.5f * 60.4f))
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.z(), (25.0f / 2.0f))
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.z(), (5.5f / 52.5f))
	);
}
...
TEST(Math, vector3f_testing_binary_plus_operator_both_vectors)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(3.5f + 2.5f, new_vector.z())
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(3.5f * 2.2f, new_vector.z())
	);
}
...
TEST(Math, vector3f_testing_binary_divide_operator_both_vectors)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(3.5f / 0.5f, new_vector.z())
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(2.5f / 0.2f, new_vector.z())
	);
}
...
{
	kn_kotek::kn_ktk::kn_math::vector4f vec(
		5.0f, 6.0f, 7.0f, 8.0f
	);
...
{
	kn_kotek::kn_ktk::kn_math::base_vec4_t data = {
		5.0f, 6.0f, 7.0f, 8.0f
	};
...
{
	kn_kotek::kn_ktk::kn_math::vector4f some(
...
{
	kn_kotek::kn_ktk::kn_math::base_vec4_t some(
...
TEST(Math, vector4f_testing_plus_equal_operator_based_on_vector)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.x(), (3.5f + 1.5f))
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.y(), (2.5f + 2.0f))
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.z(), (351.0f + 9.0f))
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.w(), (151.1f + 15.0f))
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.z(), (252.0f - 3.0f))
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.w(), (16.0f - 4.0f))
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.w(), 25.25f * 5.5f)
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.w(), (10.10f * 25.0f))
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(test1.w(), (251.0f / 2.0f))
	);
}
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(25.5f - 6.0f, new_vector.w())
	);
}
...
TEST(Math, vector4f_testing_binary_divide_operator_both_vectors)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(15.5f / 5.0f, new_vector.w())
	);
}
...
{
	kn_kotek::kn_ktk::kn_math::base_mat4x4_t copy = {
		1.0f,
		2.0f,
		3.0f,
		4.0f,
...
{
	kn_kotek::kn_ktk::kn_math::base_mat4x4_t base = {
		1.0f,
		2.0f,
		3.0f,
		4.0f,
...
TEST(Math, matrix4x4f_assignment_plus_operator)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(17.0f + 1.0f, test[0][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(18.0f + 2.0f, test[0][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(19.0f + 3.0f, test[0][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(20.0f + 4.0f, test[0][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(21.0f + 5.0f, test[1][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(22.0f + 6.0f, test[1][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(23.0f + 7.0f, test[1][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(24.0f + 8.0f, test[1][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(25.0f + 9.0f, test[2][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(26.0f + 10.0f, test[2][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(27.0f + 11.0f, test[2][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(28.0f + 12.0f, test[2][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(29.0f + 13.0f, test[3][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(30.0f + 14.0f, test[3][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(31.0f + 15.0f, test[3][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(32.0f + 16.0f, test[3][3])
	);
}
...
{
	kn_kotek::kn_ktk::kn_math::matrix4x4f copy(
		17.0f,
		18.0f,
		19.0f,
		20.0f,
	...
	kn_kotek::kn_ktk::kn_math::matrix4x4f copy2{
		1.0f,
		2.0f,
		3.0f,
		4.0f,
	...
	kn_kotek::kn_ktk::vector<
		kn_kotek::kn_ktk::kn_math::base_decimal_t>
		data;
	...
	for (int i = 0; i < 4; ++i)
	{
		for (int j = 0; j < 4; ++j)
		{
			kn_kotek::kn_ktk::kn_math::base_decimal_t value =
				0.0f;
...
TEST(Math, matrix4x4f_assignment_multiply_operator_base_decimal)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(1.0f * value, test[0][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(2.0f * value, test[0][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(3.0f * value, test[0][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(4.0f * value, test[0][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(5.0f * value, test[1][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(6.0f * value, test[1][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(7.0f * value, test[1][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(8.0f * value, test[1][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(9.0f * value, test[2][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(10.0f * value, test[2][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(11.0f * value, test[2][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(12.0f * value, test[2][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(13.0f * value, test[3][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(14.0f * value, test[3][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(15.0f * value, test[3][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(16.0f * value, test[3][3])
	);
}
...
{
    kn_kotek::kn_ktk::kn_math::matrix4x4f
...
TEST(Math, matrix4x4f_assignment_divide_operator_decimal)
{
	...
	kn_kotek::kn_ktk::kn_math::base_decimal_t factor =
		1.f / value;

	test /= value;

	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(1.0f * factor, test[0][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(2.0f * factor, test[0][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(3.0f * factor, test[0][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(4.0f * factor, test[0][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(5.0f * factor, test[1][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(6.0f * factor, test[1][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(7.0f * factor, test[1][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(8.0f * factor, test[1][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(9.0f * factor, test[2][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(10.0f * factor, test[2][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(11.0f * factor, test[2][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(12.0f * factor, test[2][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(13.0f * factor, test[3][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(14.0f * factor, test[3][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(15.0f * factor, test[3][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(16.0f * factor, test[3][3])
	);
}
...
TEST(Math, matrix4x4f_comparison_operator_equal)
{
	...
	kn_kotek::kn_ktk::kn_math::matrix4x4f test2(
		1.0f,
		2.0f,
		3.0f,
		4.0f,
...
)
{
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(1.0f + 1.0f, test[0][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(2.0f + 1.0f, test[0][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(3.0f + 1.0f, test[0][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(4.0f + 1.0f, test[0][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(5.0f + 1.0f, test[1][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(6.0f + 1.0f, test[1][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(7.0f + 1.0f, test[1][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(8.0f + 1.0f, test[1][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(9.0f + 1.0f, test[2][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(10.0f + 1.0f, test[2][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(11.0f + 1.0f, test[2][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(12.0f + 1.0f, test[2][3])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(13.0f + 1.0f, test[3][0])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(14.0f + 1.0f, test[3][1])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(15.0f + 1.0f, test[3][2])
	);
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(16.0f + 1.0f, test[3][3])
	);
}
...
TEST(Math, vector1f_constructors)
{
	...
	kn_kotek::kn_ktk::kn_math::vector1f vec1(
...
{
		#ifdef KOTEK_USE_MATH_LIBRARY_IMPLICIT_CASTING
	kn_kotek::kn_ktk::kn_math::vector2f vec1(
		10.0f, 5.0f, 1.0f, -1.0f
	);
		#else
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(vec1.x(), 10.0f) &&
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(vec2.x(), 5.0f) &&
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(vec3.x(), 2.212f) &&
	...
	EXPECT_TRUE(
		kn_kotek::kn_ktk::is_equal(vec4.x(), 1241.1414f) &&
...
{
		#ifdef KOTEK_USE_MATH_LIBRARY_IMPLICIT_CASTING
	kn_kotek::kn_ktk::kn_math::vector3f vec1(
		10.0f, 5.0f, 1.0f, -1.0f
	);
		#else
...
{
	kn_kotek::kn_ktk::kn_math::vector4f vec1(
		10.0f, 5.0f, 1.0f, -1.0f
	);
...
TEST(Math, matrixnf_view_t_constructors)
{
	...
	kn_kotek::kn_ktk::kn_math::matrixnf_view_t view(
		p_values, 2, 2
	);

	EXPECT_TRUE(view.data() != nullptr);
	EXPECT_TRUE(view.size_of() == sizeof(p_values));
	EXPECT_TRUE(kn_kotek::kn_ktk::is_equal(view[0][0], 10.0f));
	EXPECT_TRUE(kn_kotek::kn_ktk::is_equal(view[0][1], 20.0f));
	EXPECT_TRUE(kn_kotek::kn_ktk::is_equal(view[1][0], 30.0f));
	EXPECT_TRUE(kn_kotek::kn_ktk::is_equal(view[1][1], 40.0f));
...
TEST(Math, matrixnf_view_t_plus_operators)
{
	kn_kotek::kn_ktk::kn_math::vector4f vec4(
		1.0f, 2.0f, 3.0f, 4.0f
	);
	...
	kn_kotek::kn_ktk::kn_math::matrixnf_view_t view(p_values, 2, 2);
