#include "../include/kotek_core_defines_static_render_gl.h"
	...
	ktkMainManager* p_manager)
{
	if (p_manager->Get_Splash())
	{
		p_manager->Get_Splash()->Set_Text(
			"[core]: init [defines][static][render][opengl]");
...
bool ShutdownModule_Core_Defines_Static_Render_OpenGL(ktkMainManager* p_manager)
{
	return true;
}
