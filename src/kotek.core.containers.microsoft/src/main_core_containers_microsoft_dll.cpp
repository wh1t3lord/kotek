...
bool InitializeModule_Core_Containers_Microsoft(ktkMainManager* p_manager)
{
	...
	KOTEK_INVOKE_MODULE(INIT, CORE, InitializeModule_Core_Containers_Microsoft_WRL_ComPtr, p_manager);
...
{
	KOTEK_INVOKE_MODULE(SHUTDOWN, CORE, ShutdownModule_Core_Containers_Microsoft_WRL_ComPtr, p_manager);
