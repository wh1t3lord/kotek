...
{
	// tests are a static-linkage feature: test registrars instantiate
	// concrete classes from feature modules directly, which is forbidden in
	// PLUGIN mode (no link edges between plugin dlls)
#if defined(KOTEK_USE_TESTS) && !defined(KOTEK_USE_LINKAGE_PLUGIN)
