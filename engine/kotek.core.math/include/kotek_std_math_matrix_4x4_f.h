...
KOTEK_BEGIN_NAMESPACE_MATH
	...
	{
	public:
		matrix4x4f(float m00, float m01, float m02, float m03, float m10,
			float m11, float m12, float m13, float m20, float m21, float m22,
			float m23, float m30, float m31, float m32, float m33) :
			m_base(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23,
				m30, m31, m32, m33)
		{
		}
		...
		matrix4x4f& operator+=(const matrix4x4f& data) noexcept
		{
			...
			DirectX::XMVECTOR row_original_1 = DirectX::XMLoadFloat4(
				reinterpret_cast<const DirectX::XMFLOAT4*>(&this->m_base._21));
			DirectX::XMVECTOR row_original_2 = DirectX::XMLoadFloat4(
				reinterpret_cast<const DirectX::XMFLOAT4*>(&this->m_base._31));
			DirectX::XMVECTOR row_original_3 = DirectX::XMLoadFloat4(
				reinterpret_cast<const DirectX::XMFLOAT4*>(&this->m_base._41));

			DirectX::XMVECTOR row_argument_0 = DirectX::XMLoadFloat4(
				reinterpret_cast<const DirectX::XMFLOAT4*>(&data.m_base._11));
			DirectX::XMVECTOR row_argument_1 = DirectX::XMLoadFloat4(
				reinterpret_cast<const DirectX::XMFLOAT4*>(&data.m_base._21));
			DirectX::XMVECTOR row_argument_2 = DirectX::XMLoadFloat4(
				reinterpret_cast<const DirectX::XMFLOAT4*>(&data.m_base._31));
			DirectX::XMVECTOR row_argument_3 = DirectX::XMLoadFloat4(
				reinterpret_cast<const DirectX::XMFLOAT4*>(&data.m_base._41));
		...
		matrix4x4f operator-() const noexcept
		{
			...
			DirectX::XMStoreFloat4(
				reinterpret_cast<DirectX::XMFLOAT4*>(&result.m_base._21),
				row_original_1);

			DirectX::XMStoreFloat4(
				reinterpret_cast<DirectX::XMFLOAT4*>(&result.m_base._31),
				row_original_2);
		...
		const matrix4x4f& left, const matrix4x4f& right) noexcept
	{
		...
		DirectX::XMStoreFloat4(
			reinterpret_cast<DirectX::XMFLOAT4*>(&result.Get_Base()._11),
			row_original_0);
		DirectX::XMStoreFloat4(
			reinterpret_cast<DirectX::XMFLOAT4*>(&result.Get_Base()._21),
			row_original_1);
		DirectX::XMStoreFloat4(
			reinterpret_cast<DirectX::XMFLOAT4*>(&result.Get_Base()._31),
			row_original_2);
		DirectX::XMStoreFloat4(
			reinterpret_cast<DirectX::XMFLOAT4*>(&result.Get_Base()._41),
			row_original_3);
