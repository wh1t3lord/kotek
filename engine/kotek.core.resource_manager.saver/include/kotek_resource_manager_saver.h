...
namespace Kotek
{
	namespace Core
	{
		...
		public:
			 ...
			 * wrong
			 */
			bool Save_Text(const ktk::filesystem::path& path,
				ktk::any data) noexcept override;
			 ...
			 */
			bool Save_Text_Formatted(const ktk::filesystem::path& path,
				ktk::any data) noexcept override;
		...
		private:
			 ...
			 * \return void
			 */
			void FormatTextFile_Json(ktk::ofstream& file,
				const ktk::json::value& json,
