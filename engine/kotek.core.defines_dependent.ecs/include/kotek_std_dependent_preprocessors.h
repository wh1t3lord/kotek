...
public:                                                                       \
	static const kotek::static_cstring_t<zircon_DEF_MAX_COMPONENT_NAME_SIZE>& \
	GetComponentName(void) noexcept                                           \
	{                                                                         \
	...
	{                                                                         \
		return m_component_type;                                              \
                                                                              ...
                                                                              \
private:                                                                      \
	inline static kotek::static_cstring_t<zircon_DEF_MAX_COMPONENT_NAME_SIZE> \
		m_component_name = #YourClass;                                        \
	inline static kotek::size_t m_component_name_hash = kotek::hash_t<        \
		kotek::static_cstring_t<zircon_DEF_MAX_COMPONENT_NAME_SIZE>>{}(       \
		m_component_name);                                                    \
	kotek::uint8_t m_component_type = kComponentType##YourClass;              \
